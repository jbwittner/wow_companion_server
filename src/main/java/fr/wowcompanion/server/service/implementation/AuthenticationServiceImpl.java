...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Autowired
    public AuthenticationServiceImpl(final AuthenticationFacade authenticationFacade, final UserAccountRepository userAccountRepository){
    ...
    public Boolean isRegistred() {
        ...
        return this.userAccountRepository.existsByBlizzardId(blizzardDetail.getBlizzardId());
    }
